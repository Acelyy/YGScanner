        ...
        spKu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                if (position == 0) {
                    ...
                    Log.i("spKu", "spKu");
                    ArrayAdapter<String> adapter2 = new ArrayAdapter<>(SmrkActivity.this, android.R.layout.simple_spinner_item, list_qu);
...
//                        String query = "select * from  YG_RKXXM where INVID = "+invId;
                        ...
                        String insert = "insert into YG_RKXXM(INVID,SCHDNO,ORDERLENGTH,ORDERTHICK,THEOWGT,REALWTG,PRODSPECNO,KU,QU,PAI) "
                                + " values ('" + invId + "'" + ",'" + schdNo + "','"
